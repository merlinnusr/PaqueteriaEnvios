...
<div class="center">
    ...
    <a href="{{ route('/') }}" class="myButton">Volver</a>
            ...
            $().ready(function() {
                (function() {
                    var requestAnimationFrame = window.requestAnimationFrame || window
                        .mozRequestAnimationFrame || window.webkitRequestAnimationFrame ||
                ...
                setTimeout(function() {
                    ...
                    $('.js-toaster_toast').removeClass('js-ag-hide').addClass(
                        'js-ag-animated js-ag-bounce-in-up')
                }, 800);
                ...
                function render() {
                    ...
                    while (len--)
                        if (parts[len].y < 0 || parts[len].lifeTime > maxLifeTime) {
                            ...
                            ctx.drawImage(smokeImage, offsetX, offsetY, parts[len].size, parts[len]
                                .size);
                            ctx.restore()
                        }
                    spawn();
                ...
                smoke.prototype.update = function() {
                    ...
                    this.size = this.startSize + ((this.endSize - this.startSize) * lifePerc *
                        .1);
