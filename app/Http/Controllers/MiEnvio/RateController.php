...
namespace App\Http\Controllers\MiEnvio;
...
{
    public function index(PackageDetailPostRequest $request)
    {
        ...
        $shipment = [
            ...
            'weight' => $validatedRequest->weight,
